...
StatusPageAPI.prototype.get = function (element, callback) {
    ...
    return statuspageRequest.sendRequest("GET", element, null, {}, callback);
};

StatusPageAPI.prototype.post = function (element, args, callback) {
    var statuspageRequest = new StatusPageRequest(this);
    return statuspageRequest.sendRequest("POST", element, null, args, callback);
};

StatusPageAPI.prototype.patch = function (element, args, callback) {
  var statuspageRequest = new StatusPageRequest(this);
  return statuspageRequest.sendRequest("PATCH", element, null, args, callback);
};

StatusPageAPI.prototype.put = function (element, args, callback) {
  var statuspageRequest = new StatusPageRequest(this);
  return statuspageRequest.sendRequest("PUT", element, null, args, callback);
};

StatusPageAPI.prototype.delete = function (element, pathparams, args, callback) {
  var statuspageRequest = new StatusPageRequest(this);
  return statuspageRequest.sendRequest("DELETE", element, pathparams, args, callback);
};
